 ...
 * the License.
 */
package com.king.mybatisplus.generator.config.po;

import com.baomidou.mybatisplus.core.toolkit.CollectionUtils;
import com.baomidou.mybatisplus.core.toolkit.StringUtils;
import com.king.mybatisplus.generator.config.StrategyConfig;
...
public class TableInfo {
    ...
    private String entityNameLowerCamelCase;
    ...
    private String serviceNameLowerCamelCase;
    ...
    public void setEntityName(String entityName) {
        ...
        String prefix = entityName.substring(0, 1).toLowerCase();
        this.setEntityNameLowerCamelCase(prefix + entityName.substring(1));
    }

    public String getEntityNameLowerCamelCase() {
        return entityNameLowerCamelCase;
    }

    public void setEntityNameLowerCamelCase(String entityNameLowerCamelCase) {
        this.entityNameLowerCamelCase = entityNameLowerCamelCase;
    }
    ...
    public void setServiceName(String serviceName) {
        ...
        String prefix = serviceName.substring(0, 1).toLowerCase();
        this.setServiceNameLowerCamelCase(prefix + serviceName.substring(1));
    }

    public String getServiceNameLowerCamelCase() {
        return serviceNameLowerCamelCase;
    }

    public void setServiceNameLowerCamelCase(String serviceNameLowerCamelCase) {
        this.serviceNameLowerCamelCase = serviceNameLowerCamelCase;
    }
